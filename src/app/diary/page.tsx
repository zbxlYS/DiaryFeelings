        ...
        <div className='w-full h-full mt-[20px] flex flex-col justify-center items-center'>
            ...
            <div className='flex px-[100px] h-[50px] border rounded-md mb-[100px] items-center justify-center'>
                <div className='flex items-center h-full'>
                    <span className='mr-[15px] cursor-pointer hover:text-[#b2a4d4]'>{'처음'}</span>
                ...
                <div className='flex items-center h-full gap-[15px]'>
                    ...
                    <span className={`py-[2px] px-[10px] cursor-pointer hover:text-[#b2a4d4] rounded-md`}>5</span>
                </div>
                <div className='flex items-center h-full'>
                    <span className='ml-[30px] cursor-pointer hover:text-[#b2a4d4]'>{'다음'}</span>
                    <span className='ml-[15px] cursor-pointer hover:text-[#b2a4d4]'>{'마지막'}</span>
                </div>
            </div>
        </div>
    )
