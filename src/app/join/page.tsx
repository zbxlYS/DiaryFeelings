...
const page = () => {
  ...
  return (
    <div className="mt-10 flex h-full w-screen flex-col items-center ">
      <div className="w-1/2">
        <div>
          <form>
            ...
            <div className="flex flex-col items-center">
              <div className="flex flex-col items-center">
                <div className="flex gap-4 items-center ">
                  <Avatar isBordered radius="full" size="lg" src={img} name='img' />
                </div>
                <label htmlFor="file">
            ...
            <div className="flex flex-col items-center">
              <div className="flex  flex-col  p-2 pt-0 w-[20rem]">
                <Input isRequired variant="underlined" name='email' type="email" label="이메일"  ref={emailRef} className="max-w-xs"/>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                onClick={confirmBtn}> 이메일 중복 확인 </Button>
                </div>
              </div>

              <p ref={msgRef}  className="p-1 text-sm font-normal">{msg}</p>
