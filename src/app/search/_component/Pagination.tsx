...
const Pagination = ({ total, limit, page, keyword }: Props) => {
            ...
            <div className="flex items-center h-full">
                {
                    prev > 1 && (
                        <span
                            ...
                            onClick={() => router.push(`/search?keyword=${keyword}&page=${prev}`)}
                        >
                            {'이전'}
                        </span>
                    )
            ...
            <div className="flex items-center h-full">
                {
                    next < totalPage && (
                        <span
                            ...
                            onClick={() => router.push(`/search?keyword=${keyword}&page=${next}`)}
                        >
                            {'다음'}
                        </span>
                    )
