          ...
          <form >
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex w-[20rem] flex-col  p-2   pt-0">
                <Input isRequired size="md" variant="underlined" onClick={nickClick} onChange={nickChange} type="text" ref={nickRef} value={nick} label="닉네임"/>
              </div>
            </div>

            <div className="flex flex-col items-center">
              <div className="flex  flex-col  p-2 pt-0 w-[20rem]">
                <Input isDisabled isRequired variant="underlined" type="text" label="아이디" ref={emailRef} value={user} className="max-w-xs"/>
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="flex flex-col items-center p-2 pt-0 w-[20rem]">
                ...
                className={`w-full ${pwRef.current?.value && pwRef2.current?.value && pwRef.current?.value === pwRef2.current?.value? 'bg-black text-white' : 'bg-neutral-200 hover:shadow-lg'} shadow-md dark:text-[#171717]`} 
                onClick={editSubmit} > 정보 변경하기</Button>
              </div>
